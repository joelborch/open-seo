...
import { BigQueryProjectionCard } from "@/client/features/bigquery/BigQueryProjectionCard";
...
function ProjectIntegrationsRoute() {
  ...
  return (
    <div className="space-y-8">
      ...
      <section id="bigquery" className="scroll-mt-6 space-y-3">
        <h2 className="text-sm font-medium text-base-content/50">Warehouse</h2>
        <BigQueryProjectionCard projectId={projectId} />
      </section>
    </div>
  );
}
