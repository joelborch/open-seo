...
export const gbpSchedules = sqliteTable(
  "gbp_schedules",
  {
    id: text("id").primaryKey(),
    projectId: text("project_id")
...
export const gbpSnapshots = sqliteTable(
  "gbp_snapshots",
  {
    id: text("id").primaryKey(),
    projectId: text("project_id")
...
export const gbpSnapshotAttributes = sqliteTable(
...
export const gbpSnapshotReviews = sqliteTable(
  "gbp_snapshot_reviews",
  {
    ...
    text: text("text"),
    ownerReply: integer("owner_reply", { mode: "boolean" })
      .notNull()
      .default(false),
  },
